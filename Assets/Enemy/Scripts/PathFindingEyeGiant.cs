...
public class PathFindingEyeGiant : MonoBehaviour
{
    ...
    [SerializeField] private int minDistanceProjectile = 5;
    [SerializeField] private int maxDistanceProjectile = 7;
    ...
    private float distanteProjectile;
    ...
    private void Awake()
    {
        ...
        distanteProjectile = Random.Range(minDistanceProjectile, maxDistanceProjectile);
    ...
    private void MoveToPlayer()
    {
        ...
        if (attackStarted == true)
        {
            animator.SetBool("Walk", true);
            animator.SetBool("Attack", false);
            animator.SetBool("AttackProjectile", false);
    ...
    private void AttackPlayerProjectile()
    {
        canMove = false;

        animator.SetBool("Walk", false);
        animator.SetBool("Attack", false);
        animator.SetBool("AttackProjectile", true);
    ...
    {
        if (collision.CompareTag("Player") && moveToPlayer == false)
        {
            moveToPlayer = true;
