...
public class ConstructionData : MonoBehaviour
{
    ...
    [SerializeField] private int secondBeforNextDialogue;
    ...
    public NpcConstructionAI npcConstruction;
    public BuilderHelperAI builderHelperAI;
        ...
        if (npcConstruction != null)
        {
            ...
            if (dialogueBetweenNPCs != null)
            {
                ...
                if(builderHelperAI != null)
                {
                    ...
                    StartCoroutine(ForTheDialogue());
                }
            }
        }
    }

    public void RemoveBuilderAI()
    {
        npcConstruction = null;

        dialogueBetweenNPCs.FirstNPC = null;
    }

    public void RemoveHelperAI()
    {
        builderHelperAI = null;

        dialogueBetweenNPCs.SecondNPC = null;
    }
    ...
    public void ShowFinishDialogue()
    {
        if(dialogueBetweenNPCs != null)
        {
            ...
            dialogueBetweenNPCs.StartDialogue(1);
        }
    }
    ...
    public void StopBuilidng()
    {
        StopAllCoroutines();
    }

    private IEnumerator ForTheDialogue()
    {
        while (true)
        {
            yield return new WaitForSeconds(secondBeforNextDialogue);
